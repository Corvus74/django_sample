...
SECRET_KEY = 'django-insecure-#up=yo9&^%s0$!ug497i80tmh=+)qfnaeewxc3$881@$ag!^s9'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'django_sample'),
        'USER': os.environ.get('POSTGRES_USER', 'myuserHidden123'),
